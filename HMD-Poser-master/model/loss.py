...
class PoseJointLoss(nn.Module):
    ...
    def forward(self, pred_root_orientation,
        ...
        assert pred_root_orientation.shape == gt_root_orientation.shape and \
                ...
                pred_shape.shape == gt_shape.shape and \
                pred_contact.shape == gt_contact.shape, "GT and Pred have different shape"
        ...
        contact_loss = F.binary_cross_entropy(pred_contact, gt_contact)

        total_loss = (
            self.root_orientation_weight * root_orientation_loss +
        ...
        return root_orientation_loss, local_pose_loss, global_pose_loss, joint_position_loss, accel_loss, shape_loss, contact_loss, total_loss