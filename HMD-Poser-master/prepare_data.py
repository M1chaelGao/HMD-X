    ...
    for dataroot_subset in ["BioMotionLab_NTroje", "CMU", "MPI_HDM05"]:
        ...
        for phase in ["train", "test"]:
            ...
            split_file = os.path.join(
                "prepare_data_my/data_split", dataroot_subset, phase + "_split.txt"
            )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--save_dir",
        type=str,
        default="/home/wh0146/HMD-Poser-master/data_over_2ear_my/",
        help="=dir where you want to save your generated data",
    )
    parser.add_argument(
        "--root_dir", 
        type=str, 
        default="/home/wh0146/AGRoL-main/AGRoL-main/AMASS/data/",
