...
def generate_input_features(bdata_poses, body_pose_world, bm):
    ...
    input_rotation_global_6d = rotation_global_6d[1:, [12,15, 4, 5, 0], :]
    ...
    hmd_position_global_full_gt_list = torch.cat(
        [
            input_rotation_global_6d.reshape(num_frames, -1), # (num,6个点,6旋转)->(num,36)
            input_rotation_velocity_global_6d.reshape(num_frames, -1), # （num,6个点，6d旋转速度）-》（num,36）
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--save_dir",
        type=str,
        default="/home/wh0146/HMD-Poser-master/data_over_2ear/",
