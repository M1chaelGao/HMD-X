...
def generate_input_features(bdata_poses, body_pose_world, bm):
    ...
    head_rot_6d = input_rotation_global_6d[:, 1, :]  # 形状: [num_frames, 6]
    head_vel_6d = input_rotation_velocity_global_6d[:, 1, :]
    ear_accs_flat = ear_accs.reshape(num_frames, -1)
    hmd_position_global_full_gt_list = torch.cat(
        [
            head_rot_6d,                      # [:, 0:6]  -> 头部旋转
            head_vel_6d,                      # [:, 6:12] -> 头部角速度
            ear_accs_flat,                    # [:, 12:18]-> 双耳加速度
        ],
        dim=-1,
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--save_dir",
        type=str,
        default="/home/4T-2/gyf/AgilePoserdataV1/",
...
'''python prepare_data_me.py \
     --support_dir "/home/gyf0108/Projects/hmdposer/body_models/" \
     --root_dir "/home/4T-2/whl/datas/data/raw/AMASS/" \
     --save_dir "/home/4T-2/gyf/AgilePoserdataV1/" \
     --protocol "protocol1" '''